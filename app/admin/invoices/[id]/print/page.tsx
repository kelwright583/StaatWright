        ...
        {doc.client && (
          <div style={{ marginBottom: 40 }}>
            ...
            >
              ...
              {doc.client.contact_person && (
                <div>{doc.client.contact_person}</div>
              )}
              {doc.client.address && (
