      ...
      <div style={{ maxWidth: 794, margin: "0 auto", padding: "40px 48px", background: "#fff", minHeight: "100vh" }}>
        <div style={{ backgroundColor: headerColor, padding: "24px 32px", display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 40, color: "#F3F2EE" }}>
          ...
          <div style={{ textAlign: "right" }}>
            <div style={{ fontSize: 13, opacity: 0.7, fontFamily: "sans-serif", marginBottom: 4 }}>QUOTATION</div>
            ...
            <div style={{ fontSize: 12, opacity: 0.8, lineHeight: 1.8, fontFamily: "sans-serif" }}>
              ...
              {doc.valid_until && <div>Valid Until: {formatDate(doc.valid_until)}</div>}
              <div style={{ marginTop: 4 }}>
                <span style={{ backgroundColor: doc.status === "accepted" ? "#22c55e" : doc.status === "declined" || doc.status === "expired" ? "#ef4444" : "#f59e0b", padding: "2px 10px", fontSize: 11, textTransform: "uppercase", letterSpacing: 1, color: "#fff", fontWeight: 600 }}>
                  {doc.status}
                </span>
              </div>
            </div>
        ...
        {doc.partner && (
          <div style={{ marginBottom: 40 }}>
            <div style={{ fontSize: 10, fontFamily: "sans-serif", textTransform: "uppercase", letterSpacing: 2, color: "#5C6E81", marginBottom: 8, fontWeight: 600 }}>Quote For</div>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 40 }}>
          <div style={{ width: 280, fontFamily: "sans-serif" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0", fontSize: 16, fontWeight: 700, color: "#1F2A38" }}>
              <span>TOTAL</span><span>{formatZAR(doc.total ?? 0)}</span>
            </div>
          </div>
        </div>
